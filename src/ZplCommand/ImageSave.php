...
readonly class ImageSave implements ZplCommand
{
    public const string COMMAND = '^IS';
    public const string FORMAT = '%s:%s.%s,%s';

    /** Maximum byte length of an object extension (e.g. `GRF`, `PNG`). */
    ...
    public function __construct(
        ...
        $this->printAfterStore = $printAfterStore;
    }
    ...
    public function __toString()
    {
        return self::COMMAND . sprintf(
            ...
            $this->name,
            $this->extension,
            BoolToStr::conv($this->printAfterStore),
        );
    }
}

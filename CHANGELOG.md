...
- `ZplBuilder::eraseDownloadGraphics()` and `ZplCommand\EraseDownloadGraphics` add support for `~EG` (Erase Download Graphics), erasing all downloaded graphics from the printer's storage
